...
function getLocalResults(searchTerm) {
  ...
  $.get(uri, function(response) {
    ...
    searchResults.forEach(function(business) {
      ...
      resultsString += '<span class="hidden businessID">' + business._id + '</span><span class="attending">' + numAttending + ' Going </span><span class="rsvp"><i class="fa fa-check-square" aria-hidden="true"></i></span></p>';
